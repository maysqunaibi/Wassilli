<?php
    ...
    $query = "SELECT employees.lastName, employees.firstName FROM employees LEFT JOIN customers ON customers.salesRepEmployeeNumber = employees.employeeNumber WHERE customers.salesRepEmployeeNumber IS NULL LIMIT  $start_from, $limit";
    ...
    $page_query = "SELECT employees.firstName FROM employees LEFT JOIN customers ON customers.salesRepEmployeeNumber = employees.employeeNumber WHERE customers.salesRepEmployeeNumber IS NULL";
