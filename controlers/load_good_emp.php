<?php
    ...
    $query = "SELECT employees.firstName, employees.lastName FROM employees, customers WHERE customers.salesRepEmployeeNumber = employees.employeeNumber LIMIT  $start_from, $limit";
    ...
    $page_query = "SELECT employees.firstName, employees.lastName FROM employees, customers WHERE customers.salesRepEmployeeNumber = employees.employeeNumber";
