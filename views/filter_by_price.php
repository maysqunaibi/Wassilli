...
<body>
        ...
        <div class="col-sm-12">
            <div class="Searchnav">
                <div class='input-group mb-3 pl-8  w-25 d-inline-flex  my-4 '>
                    <input type='text' id='price' class='form-control border-right-0 border'
                        placeholder='Search By price'>
                    <span class='input-group-append'>
                        <button class='btn border-left-0 border' type='button' id='priceBtn'>
    ...
    <script>
        $(document).ready(function () {
           ...
           var price = 0;
            load_data(page);
            function load_data(page,price) {
                $.ajax({
                    url: "./../controlers/prduct_price.php", cache: false, timeout: 2000,
                    method: "POST",
                    data: { page: page, price:price},
