        ...
        <div class="col-sm-12">
            <div class="Searchnav">
                <div class='input-group mb-3 pl-8  w-25 d-inline-flex  my-4 '>
                    <input type='text' id='desc' class='form-control border-right-0 border'
                        placeholder='Search By price'>
                    <span class='input-group-append'>
                        <button class='btn border-left-0 border' type='button' id='descBtn'>
        ...
        $(document).ready(function () {
           ...
           var desc = [];
            ...
            function load_data(page,price) {
                $.ajax({
                    url: "./../controlers/product_desc.php", cache: false, timeout: 2000,
                    method: "POST",
                    data: { page: page, desc:desc},
