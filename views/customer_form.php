     ...
     <div class="col-md-12">
       <div class="row">
         ...
         <div class="col-md-4 jumbotron my-5">
           <h4 class="text-center my-2">Add New Customer</h4>
           <form method="POST" id="customerForm">
             ...
             <input type="text" name="creditLimit" class="form-control" autocomplete="off" required>
             
             <input type="submit" id="create" name="add_user_customer" class="btn btn-success my-2" value="Add Customer" >
